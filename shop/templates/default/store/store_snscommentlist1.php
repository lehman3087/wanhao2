...
<div id="lazymodule">
  ...
  <ul class="fd-list">
    ...
    <li nc_type="tracerow_<?php echo $v['scomm_id']; ?>">
      <dl class="fd-wrap">
        <dt>
          <img src="<?php echo getMemberAvatarForID($v['scomm_memberid']);?>" data-param="{'id':<?php echo $v['scomm_memberid'];?>}" nctype="mcard">
          <h3><a href="index.php?act=member_snshome&mid=<?php echo $v['trace_memberid'];?>" target="_blank" data-param="{'id':<?php echo $v['trace_memberid'];?>}" nctype="mcard"><?php echo $v['scomm_membername'];?><?php echo $lang['nc_colon'];?></a><?php echo parsesmiles($v['trace_title']);?></h3>
        ...
        <dd>
          <span class="goods-time fl"><?php echo date('Y-m-d H:i',$v['scomm_time']);?></span>
