    ...
    public function get_orderOp(){
        ...
        if(empty($order_goods)){
          ...
          //  showMessage(Language::get('member_evaluation_order_notexists'),'index.php?act=member_order','html','error');
            ...
            output_data(array('evaluate_info'=>$data));
...
//        Tpl::showpage('evaluation.index');
    ...
    public function add_imageOp() {
        ...
        if($geval_info['geval_frommemberid'] != $this->member_info['member_id']) {
        ...
        $ac_id = $model_sns_alumb->getSnsAlbumClassDefault($this->member_info['member_id']);
