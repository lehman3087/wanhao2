...
define('ATTACH_WORK',ATTACH_PATH.'/store/work');
...
define('ATTACH_STORE_BARE','store');
define('ATTACH_DESIGNER_HEADER','designer/header');
...
define('ATTACH_DWORK','decoration/work');
define('ATTACH_REQUEST',ATTACH_PATH.'/member/request');
